<main class="main-admin">
	...
	<div class="container">
		<div class="col l12 m12 s12 centrado">
					...
					?>
                        <tr>
                            ...
                            <th style="text-align:center">
                                <a class="a-admin" href="<?=base_url()?>Administrador/modUser"><i class="fa fa-pencil-square-o fa-2x" title="Modificar datos del usuario" aria-hidden="true"></i></a>
                            </th>
                            <th style="text-align:center">
                            <a onclick="return confirm('desea eliminar el usuario?');" class="a-admin" href="<?=base_url()?>Administrador/deleteUser"><i class="fa fa-trash fa-2x" title="Eliminar el usuario" aria-hidden="true"></i></a>
                            </th>
                        </tr>
              <?php } ?>
                    </tbody>
			...
			<br>
			<a class="btn botonAdmin btn-warning" style="background-color: #f1692f" href="<?=base_url()?>Administrador/newUser/<?=$idEmp?>">Agregar Usuario</a>
			<?php } ?>
